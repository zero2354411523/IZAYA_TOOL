...
export class requestData extends request {
    ...
    static postJson(url, params, headers, response) {
    ...
    static getJson(url, params, headers, response) {
        if (store.state.isLoading) {
            return;
        }
        let self = this;
    ...
    static postForm(url, formData, headers, response) {
        if (store.state.isLoading) {
            return;
        }
        let self = this;
    ...
    static getForm(url, formData, headers, response) {
        if (store.state.isLoading) {
            return;
        }
        let self = this;
