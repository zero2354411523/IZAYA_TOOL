export class gesture {
  ...
  swipeUp: Function
  swipeDown: Function
  longSwipeLeft: Function
  longSwipeRight: Function
  longSwipeUp: Function
  longSwipeDown: Function
  isDoing: boolean
  constructor(dom){
    this.startPoint = {
      x1: 0,
  ...
  doSwipe() {
    switch (this.swipeCalc()) {
      case 'short-left' :
        this.doMethod(this.swipeLeft);break;
      case 'short-right' :
        this.doMethod(this.swipeRight);break;
      case 'short-down' :
        this.doMethod(this.swipeDown);break;
      case 'short-up' :
        this.doMethod(this.swipeUp);break;
      case 'long-left' :
        this.doMethod(this.longSwipeLeft);break;
      case 'long-right' :
        this.doMethod(this.longSwipeRight);break;
      case 'long-down' :
        this.doMethod(this.longSwipeDown);break;
      case 'long-up' :
        this.doMethod(this.longSwipeUp);break;
    }
  }
  /* init StartPoint */
  initFirstPoint(e) {
